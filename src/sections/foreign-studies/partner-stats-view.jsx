...
export default function PartnerStatsView() {
  ...
  const fetchStats = async () => {
    try {
      setLoading(true);
      const result = await ConsumApi.getForeignStudiesPartnersStats();
            ...
            <Card sx={{ p: 3 }}>
              <Stack direction="row" alignItems="center" spacing={2}>
                ...
                <Box>
                  ...
                  <Typography variant="h4">{stats.totalPartners || 0}</Typography>
                </Box>
              </Stack>
            </Card>
          </Grid>
          ...
          <Grid item xs={12} md={4}>
            <Card sx={{ p: 3 }}>
              <Stack direction="row" alignItems="center" spacing={2}>
                ...
                >
                  <Iconify icon="eva:trending-up-fill" width={32} height={32} />
                </Box>
                <Box>
                  <Typography variant="subtitle2" color="text.secondary">
                    Taux d&apos;acceptation
